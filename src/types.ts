...
export const QUALITY_TEMPLATES: Record<
  QualityLevel,
  RenderQuality & { label: string; description: string; bitrateAuto: boolean }
> = {
  low: {
    label: "Low (Preview)",
    description: "720p · 8 Mbps · ultrafast",
    bitrate: 8,
  ...
  medium: {
    label: "Medium",
    description: "full res · auto Mbps · fast",
    bitrate: 0,
    x264preset: "fast",
    scale: null,
    bitrateAuto: true,
  ...
  high: {
    label: "High",
    description: "full res · 80 Mbps · slow",
    bitrate: 80,
    x264preset: "slow",
    scale: null,
    bitrateAuto: false,
